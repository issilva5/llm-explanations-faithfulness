...
for model in ['gemma2-9b-it', 'mixtral-8x7b-32768', 'llama3-70b-8192', 'gpt-4o-2024-08-06']:
    ...
    for uid in uids:
        ...
        true_recs = [r['title'] for r in true_recs]
        ...
        for file in files:
            ...
            if 'recommendations' in data:
                ...
                coalition_recs = [r['title'] for r in coalition_recs]
            else:
                coalition_recs = []
...
df.to_csv('shapley_values_movies.csv', index=False)
